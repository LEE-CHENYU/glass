 ...
 */
function createLLM({ apiKey, model = "gemini-3-flash", temperature = 0.7, maxTokens = 8192, ...config }) {
 ...
 */
function createStreamingLLM({ apiKey, model = "gemini-3-flash", temperature = 0.7, maxTokens = 8192, ...config }) {
  const client = new GoogleGenerativeAI(apiKey)
